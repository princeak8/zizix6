            ...
            <div class="row">
                <div class="col-md-6">
                    ...
                    <div class="email-text">
                        <p><span>Email:</span> info@zizix6.com</p>
                    </div>
                </div>
                <div class="col-md-6">
                    <!-- Form Start-->
                        ...
                        {!! Form::open(['action' => ['HomeController@save_contact_message'], 'method'=>'POST', 'onsubmit'=>'return validateCaptcha()']) !!}
                            ...
                            <div class="contact_input_area">
                                <div class="row">
                                    ...
                                    <div class="col-md-12">
                                        <div class="form-group">
                                            <input type="text" class="form-control" name="title" id="title" placeholder="Title of Message" required value="{!! old('title') !!}">
                                        </div>
                                    </div>
                                    <!-- Single Input Area Start -->
                                    <div class="col-12">
                                    ...
                                    <div class="form-group{{ $errors->has('CaptchaCode') ? ' has-error' : '' }}">
                                        ...
                                        <!-- <div class="captcha">
                                           ...
                                           <button type="button" id="captcha-refresh" class="btn btn-success">
