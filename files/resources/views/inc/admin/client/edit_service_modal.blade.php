<div class="modal fade" id="editServiceModal" tabindex="-1" role="dialog" aria-labelledby="editServiceModalLabel" aria-hidden="true">
    <div class="modal-dialog" role="document">
        ...
        <div class="modal-header">
            ...
            <h5 class="modal-title" id="serviceModalLabel">Edit {{$clientService->name}} Package Service</h5>
        </div>
        <div id="edit-modal-content" class="modal-body pb-6">
            ...
            <form @submit.prevent="save()" class="panel-body flex flex-col justify-center">
                ...
                <div class="my-3">
                    ...
                    <select v-model="serviceId" class="form-control">
                        ...
                        @foreach($services as $service)
                            <option value="{{$service->id}}" @if($service->id == $clientService->service_id) selected @endif>{{$service->name}}</option>
                        @endforeach
                    </select>
                </div>
                <div class="my-3">
                ...
                <input type="submit" class="btn btn-primary" value="EDIIT" />
            </form>
        </div>
    ...
    createApp({
        setup() {
            ...
            let serviceId = ref('{{$clientService->service_id}}');
