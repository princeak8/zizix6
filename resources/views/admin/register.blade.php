@extends('layouts.adminAuth', ['page'=>'register'])
        ...
        <div class="col-md-8 col-md-offset-2">
            <div class="panel panel-default">
                ...
                @if(request()->session()->exists('register'))
                    <p class="alert-danger">{{session('register')}} </p>
                @endif
                    <form class="form-horizontal" role="form" method="POST" action="{{env('APP_URL').'admin/register'}}">
                        {{ csrf_field() }}
                        ...
                        <div class="form-group{{ $errors->has('profile_name') ? ' has-error' : '' }}">
                            <label for="profile_name" class="col-md-4 control-label">profile Name</label>
